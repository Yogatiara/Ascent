      ...
      {loading ? (
        ...
        <>
          <div className=" font-montserrat">
            ...
            <div className="mt-20 space-y-28 min-[850px]:mt-28 min-[850px]:space-y-32 min-[1104px]:space-y-56">
              <ServiceCard />

              <div className="mx-2  text-left min-[375px]:mx-3.5 min-[425px]:mx-6 min-[600px]:mx-9 md:mx-16 min-[1060px]:mx-8 min-[1440px]:mx-10">
                <div className="mb-3 space-y-2  ">
                  <h1 className="text-left text-2xl font-bold min-[600px]:text-3xl ">
                    Kelas Ascent Berbasis Industri
                  </h1>
                  <p className="text-left text-sm text-gray-500 min-[375px]:text-base lg:pr-80 lg:text-lg xl:text-xl">
              ...
              <div className=" bg-gray-50 py-6 min-[425px]:py-10 sm:px-10  md:px-20 min-[1173px]:px-36 min-[1440px]:px-64">
                <h1 className="px-10 pb-5 text-center text-xl font-bold min-[425px]:px-20 min-[425px]:pb-8 min-[540px]:px-56 min-[600px]:text-3xl min-[1134px]:px-72    ">
              ...
              <div>
                <h1 className="px-5 pb-20 text-center text-xl font-bold min-[425px]:px-16 min-[540px]:px-20 min-[600px]:text-3xl min-[770px]:px-28 min-[840px]:px-36 min-[900px]:px-40 lg:px-56 min-[1060px]:px-64 min-[1125px]:px-72  min-[1173px]:px-96 min-[1440px]:px-[500px]">
              ...
              <div className="min mx-4   flex-row-reverse  items-center min-[375px]:mx-9 md:mx-24 min-[900px]:flex  min-[900px]:gap-6 min-[1125px]:gap-10 min-[1139px]:gap-0 min-[1227px]:mx-40 min-[1334px]:mx-48 min-[1440px]:mx-60">
                <h1 className="mb-10 text-center text-xl font-bold min-[540px]:px-20 min-[600px]:text-2xl min-[900px]:px-0 min-[900px]:text-right min-[1139px]:pl-11 min-[1173px]:pl-28">
            ...
            <div className="mx-3 mt-96 space-y-8 pb-24 min-[375px]:mx-6 min-[470px]:mx-10 min-[700px]:mt-52 min-[1060px]:mx-28 xl:mx-56 min-[1440px]:mx-72">
